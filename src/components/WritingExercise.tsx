...
import { WritingPrompt, WritingEvaluation } from '../types';
import { PenTool, Sparkles, CheckCircle2, AlertTriangle, ArrowRight, Loader2, BookOpen, RotateCcw, Award, FileText } from 'lucide-react';
