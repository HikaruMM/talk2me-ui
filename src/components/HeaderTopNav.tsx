...
export const HeaderTopNav: React.FC<HeaderTopNavProps> = ({
  ...
  const handleQuickSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (quickUrl.trim()) {
      onOpenCreateModal(quickUrl.trim());
      setQuickUrl('');
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* User Profile Avatar with Popup Menu */}
            <div className="relative pl-2 border-l border-[#E4E8F0] dark:border-[#334155]">
              <button
                type="button"
                onClick={() => {
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-3 w-80 bg-white dark:bg-[#1E293B] rounded-3xl shadow-2xl border border-[#E4E8F0] dark:border-[#334155] p-5 z-50 animate-in fade-in zoom-in-95 duration-150 space-y-4">
                  ...
                  <div className="flex items-center gap-3 pb-3 border-b border-[#E4E8F0] dark:border-[#334155]">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-blue-500 to-indigo-600 text-white font-extrabold text-base flex items-center justify-center shadow-md">
                      KD
                    </div>
                    <div className="overflow-hidden">
                      <h4 className="font-extrabold text-sm text-[#1B1F2E] dark:text-white truncate">Kỳ Duyên</h4>
                      <p className="text-xs text-slate-500 dark:text-slate-400 truncate">kyduyendo22@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-900 dark:text-amber-200 space-y-3">
                    ...
                    <p className="text-xs text-amber-800 dark:text-amber-300 font-medium leading-relaxed">
                      Bạn đã hoàn thành mục tiêu học tập <strong>{streakCount} ngày liên tiếp</strong>. Giữ vững phong độ nhé!
                    </p>

                    {/* Streak Progress Indicator */}
                    <div className="space-y-1">
                      <div className="flex justify-between text-[11px] font-bold text-amber-700 dark:text-amber-400">
                        <span>Mục tiêu hôm nay</span>
                        <span>20/20 thẻ (100%)</span>
                      </div>
