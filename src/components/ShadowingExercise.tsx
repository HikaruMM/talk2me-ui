...
import { Mic, Square, Play, RotateCcw, Volume2, ArrowRight, Activity, CheckCircle2 } from 'lucide-react';
...
export const ShadowingExercise: React.FC<ShadowingExerciseProps> = ({
  ...
  const startRecording = async () => {
    try {
      ...
      console.warn('Microphone permission denied, falling back to simulation mode');
      setIsRecording(true);
      setTimeout(() => {
