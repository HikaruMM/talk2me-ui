...
export const FlashcardPlayer: React.FC<FlashcardPlayerProps> = ({
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in duration-200">
      ...
      {/* MODE 1: LARGE INTERACTIVE FLASHCARD PLAYER */}
      {activeMode === 'flashcard' && (
        <div className={`space-y-6 ${isFullscreen ? 'fixed inset-0 z-50 bg-[#F8FAFC] dark:bg-[#0F172A] text-slate-900 dark:text-white p-6 overflow-y-auto flex flex-col justify-between' : ''}`}>
          ...
          {/* Header Bar with Counters: Đang học (Left) & Đã biết (Right) */}
          <div className="flex items-center justify-between gap-4">
            {/* Orange Counter Badge: Đang học */}
          ...
          >
            ...
            {/* Bottom Keyboard Shortcut Instruction Bar */}
          ...
          {/* Action Bar below card (Matching Screenshot 2) */}
          <div className="flex items-center justify-between gap-4 pt-2">
            ...
            {/* Center: X (Đang học) & Check (Đã biết) Swipe Buttons */}
            <div className="flex items-center gap-4">
              {/* Red/Orange X Button: Đang học */}
              <button
                type="button"
          ...
          {/* Card List Overview Below Player */}
