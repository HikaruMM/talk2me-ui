...
import { ArrowRight, Sparkles, CheckCircle2, Play, Users, Youtube, Star } from 'lucide-react';
    ...
    <section className="relative overflow-hidden pt-8 pb-16 lg:py-20 bg-gradient-to-b from-[#F7F8FB] via-white to-[#F7F8FB] dark:from-[#0F172A] dark:via-[#1E293B] dark:to-[#0F172A]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          {/* Right Hero Image Column with Floating Badges (Meekoo Style) */}
          <div className="lg:col-span-5 relative flex justify-center items-center">
            ...
            {/* Floating Badge 1: Top Right - Students Count */}
