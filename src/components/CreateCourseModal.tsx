...
import { X, Sparkles, Youtube, CheckCircle2, Loader2, AlertCircle, ArrowRight, Play } from 'lucide-react';
...
export const CreateCourseModal: React.FC<CreateCourseModalProps> = ({
  ...
  const handleStartGeneration = async (e: React.FormEvent) => {
    ...
    // Simulate real-time progress steps while fetching backend API
